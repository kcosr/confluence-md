...
confluence-md is a Git-style CLI for bidirectional Confluence ↔ Markdown sync. See `docs/design.md` for complete specifications.
...
npm run server     # Run fake Confluence server
```

### Project Structure

- `src/` - Main source code
- `server/` - Fake Confluence server for testing
- `test/` - Test files
